	...
	_pushassist.Url			= "https://sekolahotomasi.pushassist.com";
	_pushassist.assetsURL	= "https://cdn.pushassist.com/account";
	_pushassist.subdomain	= "sekolahotomasi";
	...
	function notificationPopup() {
	    ...
	    jQuery("body").append('<div class="pushassist_notification8 top_center"><div class="pushassist_notification8_inner_wraper" id="pushassist_notification_inner_wraper"> <div class="pushassist_notification8_image_wraper"> <img src="https://3.bp.blogspot.com/-FT0CRtZ3ar0/Xn7G6Wcm8WI/AAAAAAAACD4/GYfENHRdutESWVlwWSWU6qphk6Mf_bmSwCLcBGAsYHQ/s1600/alarm.png"> </div> <div class="pushassist_notification8_text_wraper"> <span class="pushassist_notification8_title"> <strong> <span class="camelize"> ' + title + '</span></strong> </span> <p class="pushassist_notification8_message"> ' + subtitle +' </p> </div> <div class="pushassist_notification8_footer_wraper"> <a class="pushassist8_branding" target="_blank" href="https://pushassist.com/"></a> <span><a class="pushassist8_powered_by" target="_blank" href="https://sekolahotomasi.com/">' + powered_by_text + '</a></span> <div class="pushassist8_button_wrapper"> <button class="pushassist8_btn_close" id="psa_close">'+ disallow +'</button> <button class="pushassist8_btn_allow" id="psa_allow">' + allow + '</button></div> </div> </div> </div>');
